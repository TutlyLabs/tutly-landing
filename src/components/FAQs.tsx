...
export function FAQs() {
  return (
    <div className="my-8 mx-auto grid grid-flow-row grid-cols-2 gap-4">
...
function Card({
  ...
  return (
    <div className="flex gap-2 items-start shadow-md rounded-lg p-8 group">
      <div className="p-2 rounded border border-gray-600 group-hover:text-blue-500 group-hover:border-blue-500 duration-500">{icon}</div>
      <div className="">
        <h1 className="text-lg tracking-wide font-semibold transition-transform group-hover:translate-x-4 duration-500">{question}</h1>
